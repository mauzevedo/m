                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="config_token" class="form-control codigo_servico_correios" value="<?php echo (isset($pagseguro) ? $pagseguro->config_token : set_value('config_token')); ?>">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="config_ambiente" class="form-control">
                                        <?php
                                        if (isset($pagseguro)) : ?>
                                            <option value="1" <?php echo ($pagseguro->config_ambiente == 1 ? 'selected' : ''); ?>>Sanbox - Teste</option>
                                            <option value="0" <?php echo ($pagseguro->config_ambiente == 0 ? 'selected' : ''); ?>>Produção - Real</option>
                                        <?php else : ?>
                                            <option value="1">Sanbox - Teste</option>
